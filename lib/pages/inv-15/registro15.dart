...
class Registro15 extends StatefulWidget {
  ...
  Regi r;
  String invernadero;
  Registro15([this.id, this.nuser, this.invernadero, this.id_inver, this.r]);
  @override
  _Registro15State createState() => _Registro15State(
      this.id, this.nuser, this.invernadero, this.id_inver, this.r);
}

class _Registro15State extends State<Registro15> {
  String nuser = " ";
  int id_inver;
  String mensaje;
  bool local;
  ...
  _Registro15State(this.id, this.nuser, this.invernadero, this.id_inver,
      [this.r]) {
    if (this.r == null) {
      print("vacio");
      editar = false;
    ...
    if (validateDatos()) {
      if (editar) {
        ...
        if (conecctionResult != ConnectivityResult.none) {
          ...
          var response;
          try {
            response = await http.put(Constant.DOMAIN + "/actualizar15/",
                headers: hd,
                body: {
