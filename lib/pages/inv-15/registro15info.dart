...
import 'dart:convert';
import 'dart:io';
import 'package:calidad/pages/inv-15/registro15.dart';
...
class RegInfo15 extends StatefulWidget {
  Regi r;
  bool local;
  RegInfo15(this.r, this.local);
  @override
  _RegInfo15State createState() => _RegInfo15State(this.r, this.local);
}

class _RegInfo15State extends State<RegInfo15> {
  Regi r;
  bool local;
  String mensaje = "";
  _RegInfo15State(this.r, this.local);
