...
class RegistrosView15 extends StatefulWidget {
  String invernadero;
  String user;
  RegistrosView15([this.user, this.invernadero]);
  @override
  _RegistrosView15State createState() =>
      _RegistrosView15State(this.user, this.invernadero);
}

class _RegistrosView15State extends State<RegistrosView15> {
  String invernadero;
  DateTime _dateTime;
  bool lista;
  Future fregistros;
  ...
  async {
    ...
    if (sharedPreferences.getString('tk') != null) {
      ...
      try {
        response = await http
            .post(Constant.DOMAIN + "/registros15/", headers: hd, body: {
          "fecha": _dateTime.toString(),
          "name": this.invernadero,
