...
class Registro13 extends StatefulWidget {
  String nuser;
  int id_inver;
  int id;
  Regi16 r;
  String invernadero;
  Registro13([this.id, this.nuser, this.invernadero, this.id_inver, this.r]);
  @override
  _Registro13State createState() => _Registro13State(
      this.id, this.nuser, this.invernadero, this.id_inver, this.r);
}

class _Registro13State extends State<Registro13> {
  String nuser = " ";
  int id_inver;
  String mensaje;
  bool local;
  ...
  _Registro13State(this.id, this.nuser, this.invernadero, this.id_inver,
      [this.r]) {
    if (this.r == null) {
      editar = false;
    } else {
    ...
    if (validateDatos()) {
      if (editar) {
        ...
        if (conecctionResult != ConnectivityResult.none) {
          ...
          var response;
          try {
            response = await http.put(Constant.DOMAIN + "/actualizar13/",
                headers: hd,
                body: {
