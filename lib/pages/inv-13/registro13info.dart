...
import 'dart:convert';
import 'dart:io';
import 'package:calidad/pages/inv-13/registro13.dart';
...
class RegInfo13 extends StatefulWidget {
  Regi16 r;
  bool local;
  RegInfo13(this.r, this.local);
  @override
  _RegInfoState13 createState() => _RegInfoState13(this.r, this.local);
}

class _RegInfoState13 extends State<RegInfo13> {
  Regi16 r;
  bool local;
  String mensaje = "";
  _RegInfoState13(this.r, this.local);
