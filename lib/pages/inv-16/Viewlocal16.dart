...
class Viewlocal16 extends StatefulWidget {
  @override
  var datos;
  Viewlocal16([this.datos]);

  _Viewlocal16State createState() => _Viewlocal16State(this.datos);
}

class _Viewlocal16State extends State<Viewlocal16> {
  @override
  var datos;
  String mensaje;
  bool lista;
  StreamController<List<Regi16>> ldR;
  _Viewlocal16State([this.datos]);
