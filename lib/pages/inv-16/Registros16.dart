...
class RegistrosView16 extends StatefulWidget {
  String invernadero;
  String user;
  RegistrosView16([this.user, this.invernadero]);
  @override
  _Registros16ViewState createState() =>
      _Registros16ViewState(this.user, this.invernadero);
}

class _Registros16ViewState extends State<RegistrosView16> {
  String invernadero;
  DateTime _dateTime;
  bool lista;
  Future fregistros;
  ...
  async {
    ...
    if (sharedPreferences.getString('tk') != null) {
      ...
      try {
        response = await http
            .post(Constant.DOMAIN + "/registros16/", headers: hd, body: {
          "fecha": _dateTime.toString(),
          "name": this.invernadero,
