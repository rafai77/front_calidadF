...
class Viewlocal12 extends StatefulWidget {
  @override
  var datos;
  Viewlocal12([this.datos]);

  _ViewlocalState12 createState() => _ViewlocalState12(this.datos);
}

class _ViewlocalState12 extends State<Viewlocal12> {
  @override
  var datos;
  String mensaje;
  bool lista;
  StreamController<List<Regi12>> ldR;
  _ViewlocalState12([this.datos]);
