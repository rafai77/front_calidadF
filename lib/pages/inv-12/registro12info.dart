...
class RegInfo12 extends StatefulWidget {
  Regi12 r;
  bool local;
  RegInfo12(this.r, this.local);
  @override
  _RegInfoState12 createState() => _RegInfoState12(this.r, this.local);
}

class _RegInfoState12 extends State<RegInfo12> {
  Regi12 r;
  bool local;
  String mensaje = "";
  _RegInfoState12(this.r, this.local);
                ...
                child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text("Brix1 = " + r.Brix1.toString()),
                        Text("Brix2 = " + r.Brix2.toString()),
                        Text("Brix3 = " + r.Brix1.toString()),
                        Text("Brix4 = " + r.Brix2.toString()),
