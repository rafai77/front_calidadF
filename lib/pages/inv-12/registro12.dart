...
class Registro12 extends StatefulWidget {
  ...
  Regi12 r;
  String invernadero;
  Registro12([this.id, this.nuser, this.invernadero, this.id_inver, this.r]);
  @override
  _RegistroState12 createState() => _RegistroState12(
      this.id, this.nuser, this.invernadero, this.id_inver, this.r);
}

class _RegistroState12 extends State<Registro12> {
  String nuser = " ";
  int id_inver;
  String mensaje;
  bool local;
  ...
  _RegistroState12(this.id, this.nuser, this.invernadero, this.id_inver,
      [this.r]) {
    if (this.r == null) {
      print("vacio");
      editar = false;
